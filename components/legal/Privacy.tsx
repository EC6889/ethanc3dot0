        ...
        <div className="min-h-screen bg-slate-950 text-slate-300 font-sans pt-24 pb-12 px-6 md:px-12 max-w-4xl mx-auto">
            ...
            <div className="space-y-8 leading-relaxed text-sm md:text-base">
                <section>
                    ...
                    <p>Ethan C. ("we", "our", or "us") operates this portfolio website. This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data.</p>
                </section>
