          ...
          >
            <div>
              ...
              <p className="text-slate-400 text-sm md:text-base mt-6 leading-loose max-w-md">
                Available for operations management and consulting roles. If you need someone to
                organize your support team, improve your workflows, or configure your CX platforms,
                let's talk.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-4 max-w-lg w-full">
                  ...
                  <div className="p-5 flex items-center gap-5 relative z-10">
                    ...
                    <div className="flex-1 space-y-1">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="px-1.5 py-0.5 rounded bg-brand-purple/20 border border-brand-purple/30 text-brand-purple text-[8px] font-mono font-bold uppercase">
                          Latest
                        </span>
                      </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
                <a href="mailto:gmeal6889@gmail.com" className="block h-full w-full">
                  <GlassCard
                    className="p-0 h-full group relative overflow-hidden transition-all border-slate-800 hover:border-brand-blue/40 hover:shadow-[0_0_25px_rgba(59,130,246,0.15)] bg-[#0f172a]/80"
                    hoverEffect={false}
                  >
                    <div className="p-5 h-full flex flex-col justify-between gap-4 relative z-10">
                      ...
                      />
                      <div>
                        <h5 className="text-xs font-bold text-white mb-1 font-display">
                          Email Protocol
                        </h5>
                        <p className="text-[9px] font-mono text-slate-500 truncate group-hover:text-brand-blue/70">
                          gmeal6889
                        </p>
                      </div>
                    </div>
                  ...
                  >
                    <div className="p-5 h-full flex flex-col justify-between gap-4 relative z-10">
                      ...
                      <div>
                        ...
                        <p className="text-[9px] font-mono text-slate-500 group-hover:text-brand-blue/70">
                          /in/echia6889
                        </p>
                      </div>
                    </div>
              ...
              <div className="p-6 md:p-8 flex-grow flex flex-col relative z-10">
                ...
                <form onSubmit={handleSubmit} className="space-y-6 flex-grow">
                  ...
                  <div className="group space-y-2 relative">
                    <label
                      htmlFor="name"
                      className="text-[9px] font-mono text-slate-500 group-focus-within:text-brand-cyan transition-colors uppercase tracking-wider flex justify-between"
                    >
