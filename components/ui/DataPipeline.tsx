  ...
  return (
    <div className={`flex flex-col items-center pointer-events-none z-0 ${className}`}>
      ...
      <div className="w-full h-full bg-slate-800/40 relative overflow-hidden rounded-full">
        ...
        <motion.div
          className="absolute inset-0 bg-gradient-to-b from-brand-cyan-deep via-brand-cyan to-brand-cyan-deep"
          initial={{ y: '-100%' }}
          animate={{ y: '100%' }}
          transition={{
            duration: 3,
        ...
        <motion.div
          className="absolute inset-0 bg-gradient-to-b from-brand-purple-deep via-brand-purple to-brand-purple-deep"
          initial={{ y: '-100%' }}
          animate={{ y: '100%' }}
          transition={{
            duration: 4,
