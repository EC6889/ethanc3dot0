    ...
    <div className="min-h-screen bg-slate-950 text-slate-300 font-sans pt-24 pb-12 px-6 md:px-12 max-w-4xl mx-auto">
      ...
      <div className="space-y-8 leading-relaxed text-sm md:text-base">
        <section>
          ...
          <p>
            By accessing and using this website (the "Site"), operated by Ethan C. ("we," "us," or
            "our"), you agree to be bound by these Terms and Conditions. If you disagree with any
        ...
        <section>
          ...
          <p>
            Other than the content you own, under these Terms, Ethan C. and/or its licensors own all
            the intellectual property rights and materials contained in this Site. You are granted a
          ...
          <ul className="list-disc pl-5 mt-2 space-y-1 text-slate-400">
            ...
            <li>
              Using this Site in any way that is or may be damaging to this Site or to any person or
              business entity.
            </li>
            <li>
              Engaging in any data mining, data harvesting, data extracting, or any other similar
              activity in relation to this Site.
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p>
            This Site is provided "as is," with all faults, and Ethan C. expresses no
            representations or warranties, of any kind related to this Site or the materials
            contained on this Site. Nothing contained on this Site shall be interpreted as advising
            you.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            In no event shall Ethan C., nor any of its officers, directors, and employees, be held
            liable for anything arising out of or in any way connected with your use of this Site
            whether such liability is under contract. Ethan C., including its officers, directors,
            and employees shall not be held liable for any indirect, consequential, or special
            liability arising out of or in any way related to your use of this Site.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            You hereby indemnify to the fullest extent Ethan C. from and against any and/or all
        ...
        <section>
          ...
          <p>
            Ethan C. is permitted to revise these Terms at any time as it sees fit, and by using
            this Site you are expected to review these Terms on a regular basis.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            and you submit to the non-exclusive jurisdiction of the state and federal courts located
            in Malaysia for the resolution of any disputes.
          </p>
        </section>
      </div>
    </div>
