   ...
   depth = 0
      ...
      `}
         ...
         >
            ...
            {/* Icon */}
            <div className={`shrink-0 relative z-10 ${isSelected ? 'text-brand-cyan' : 'text-slate-600 group-hover:text-slate-400'}`}>
               {type === 'folder' ? (
            ...
            <div className="mb-16 flex flex-col md:flex-row md:items-end justify-between gap-6">
               <div>
                  <div className="flex items-center gap-3 mb-4">
                     ...
                     <h2 className="text-[10px] font-mono text-brand-cyan tracking-[0.2em] uppercase">05. ARCHIVE</h2>
                  </div>
